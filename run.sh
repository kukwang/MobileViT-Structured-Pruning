...
pr=0.5
dense_path=/home/user/kwangsoo/paper_codes/my_paper/KICS-2023-mine/save/mobilevit_${mode}_${dataset_name}_${epoch}ep_dense.pth.pth
...
# --model-config ${config} --mode ${mode} --resize ${resize} --cprune-rate ${pr} --dense-model ${dense_path} \
