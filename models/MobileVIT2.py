...
from model_parts import BaseEncoder
from model_parts import ConvLayer, LinearLayer, GlobalPool, Identity
from model_parts import InvertedResidual
from model_parts import MobileViTBlockv2 as Block
...
class MobileViTv2(BaseEncoder):
    ...
    def __init__(self, opts, *args, **kwargs) -> None:
        ...
        mobilevit_config = get_configs(opts=opts)
